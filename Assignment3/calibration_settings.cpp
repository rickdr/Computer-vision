...
{
public:
    calibration_settings() : goodInput(false) {}
...
static inline void read(const FileNode& node, calibration_settings& x, const calibration_settings& default_value = calibration_settings())
{
    if (node.empty())
        x = default_value;
    else
