 ...
 */
Assignment3::Assignment3(const string &dp, const int cva) :
 ...
 * What you can hit
 */
void Assignment3::showKeys()
{
	cout << "Assignment3 v" << VERSION << endl << endl;
 ...
 * - Run it!
 */
void Assignment3::run(int argc, char** argv)
{
	for (int v = 0; v < m_cam_views_amount; ++v)
	{
